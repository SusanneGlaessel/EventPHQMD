...
void PEventHadrons::SetParameters(Int_t eventId, Int_t nHadrons, Int_t nParticipants, Int_t iSub, Int_t iNum, Float_t b,  std::array<Float_t,4> phi, std::array<Float_t,4> psi)
{
  fEventId = eventId;
  fNHadrons = nHadrons;
