    ...
    fIAntiprot(Iantiprot)
{
  ...
  cout << endl;
  cout << "Mass of target (GeV/c*c)         : " << fATarg                                << endl;
  cout << "Number of protons in target      : " << fZTarg                                << endl;
  cout << "Mass of projectile (GeV/c*c)     : " << fAProj                                << endl;
  cout << "Number of protons in projectile  : " << fZProj                                << endl;
  ...
  cout << "Impact parameter b (fm)          : " << setprecision(2) << fBMin << "-" << setprecision(2) << fBMax << endl;
  cout << "--------------------------------------------- "                               << endl;
  cout << endl;
};
...
TString PRun::GetPHSDver() const
{
  ...
  if (fIDqpm == 1) PHSDvName = "PHSD5.X with DQPM(T,muB) for QGP";
  return PHSDvName;
} 
...
void PRun::Print(Option_t* /*option*/) const
{
  ...
  cout << "------------------------------------------------------------"    << endl
       ...
       << "Antiproton beam (projectile)      : " << GetYesNo(TMath::Abs(fIAntiprot))    << endl
       << "------------------------------------------------------------"    << endl;
